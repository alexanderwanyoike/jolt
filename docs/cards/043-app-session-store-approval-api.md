...
- [ ] Apps can create a pending session request with app identity, display name, requested identity, and requested capabilities.
- [ ] Admin API can list pending requests.
- [ ] Admin API can approve/reject pending requests.
- [ ] Approved sessions receive a token.
- [ ] Admin API can list and revoke sessions.
- [ ] Revoked sessions cannot be used.
- [ ] Session state survives daemon restart.
- [ ] Tests cover request, approve, reject, revoke, and restart persistence.
